; ModuleID = '/home/aayusphere/IPACO/llvm-project/InterProcCP/05.c'
...
entry:
  ...
  call void @foo(i32 noundef 100, i32 noundef 400, i32 noundef 1000, i32 noundef %0)
  ret i32 0
}
...
entry:
  ...
  call void @bar(i32 noundef 2000, i32 noundef %0, i32 noundef 1000)
  ...
  call void @foo(i32 noundef 100, i32 noundef %5, i32 noundef %6, i32 noundef 800)
  ret void
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 noundef %3)
  ret void
}
