; ModuleID = '/home/aayusphere/IPACO/llvm-project/InterProcCP/03.c'
...
if.then:                                          ; preds = %entry
  ...
  store i32 %add1, i32* %z.addr, align 4
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @funx(i32 noundef %5, i32 noundef %6)
  %7 = load i32, i32* %w.addr, align 4
  %8 = load i32, i32* %z.addr, align 4
  call void @barx(i32 noundef %7, i32 noundef %8)
  ret void
}
...
entry:
  ...
  call void @foox(i32 noundef %0, i32 noundef 8, i32 noundef 9, i32 noundef 0)
  ret i32 0
}
